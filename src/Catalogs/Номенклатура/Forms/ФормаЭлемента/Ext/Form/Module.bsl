...
//
// Возвращаемое значение:
//  Произвольный - объект метаданных или Неопределено
&НаКлиенте
...
//
// Возвращаемое значение:
//  Любой - значение поля Справочник.Номенклатура или Неопределено
&НаКлиенте
...
//
// Возвращаемое значение:
//  Перечисление.ТипыНоменклатуры - значение из ТипыНоменклатуры или Неопределено
&НаКлиенте
