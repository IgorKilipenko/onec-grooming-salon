...
Процедура ТоварыКоличествоПриИзменении(_)
    _текущаяСтрокаТовары = Элементы.Товары.ТекущиеДанные;
    обновитьСуммуДокумента(_текущаяСтрокаТовары);
КонецПроцедуры

&НаКлиенте
Процедура ТоварыТоварПриИзменении(_)
    _текущаяСтрокаТовары = Элементы.Товары.ТекущиеДанные;
    _текущаяСтрокаТовары.Цена = получитьЦенуПродажи(_текущаяСтрокаТовары.Товар);
...
Процедура УслугиУслугаПриИзменении(_)
    _текущаяСтрокаУслуги = Элементы.Услуги.ТекущиеДанные;
    _текущаяСтрокаУслуги.Стоимость = получитьЦенуПродажи(_текущаяСтрокаУслуги.Услуга);
