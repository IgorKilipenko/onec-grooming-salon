...
Процедура ТоварыТоварПриИзменении(элемент)
    текущаяСтрокаТовары = Элементы.Товары.ТекущиеДанные;
    цена = РаботаСЦенамиВызовСервера.ПолучитьЦенуПродажиНаДату(текущаяСтрокаТовары.Товар);
...
Процедура УслугиУслугаПриИзменении(элемент)
    ...
    цена = РаботаСЦенамиВызовСервера.ПолучитьЦенуПродажиНаДату(текущаяСтрокаУслуги.Услуга);
