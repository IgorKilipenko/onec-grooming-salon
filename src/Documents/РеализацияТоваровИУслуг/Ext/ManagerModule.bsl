...
Функция ПроверитьОплатуДокумента(Знач документРТУСсылка) Экспорт
    ...
    текстЗапросаПоступленияДС =
        ...
        |ГДЕ
        |	ПоступлениеНаРасчетныйСчет.ДокументОснование = &Ссылка
        ...
        |	ВТ_Поступления_БанкМКасса.ДокументОснование КАК ДокументОснование
        |ПОМЕСТИТЬ ВТ_Поступления
        |ИЗ
        |	ВТ_Поступления_БанкМКасса КАК ВТ_Поступления_БанкМКасса
        |
        |СГРУППИРОВАТЬ ПО
        |	ВТ_Поступления_БанкМКасса.ДокументОснование
        |;";
