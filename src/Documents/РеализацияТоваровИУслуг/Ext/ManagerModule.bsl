...
Функция ПолучитьОстатокСуммыПоЗаказуКлиента(Знач записьКлиентаСсылка, Знач моментВремени) Экспорт
    ...
    запросЗаказыКлиентовОстатки.УстановитьПараметр("ЗаписьКлиента", записьКлиентаСсылка);
    ...
    запросЗаказыКлиентовОстатки.Текст =
        ...
        |       &МоментВремени, ЗаписьКлиента = &ЗаписьКлиента) КАК ЗаказыКлиентовОстатки
        |";
