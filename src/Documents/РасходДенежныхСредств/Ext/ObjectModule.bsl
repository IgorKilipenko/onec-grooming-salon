...
Функция заполнитьДокументНаОсновании(Знач данныеЗаполнения)
    ...
    Если НЕ (типДокументаОСнования = Тип("ДокументСсылка.ПоступлениеУслуг")
            ИЛИ типДокументаОСнования = Тип("ДокументСсылка.ПоступлениеТоваров")
...
Процедура выполнитьДвижениеДенежныеСредстваРасход(Знач строкаРасходДС)
...
Функция получитьВыборкуДокументРасходДенежныхСредств(Знач документСсылка) // => Выборка | Неопределено
...
Функция проверитьОстаткиДенежныхСредствПоКассе(Знач касса = Неопределено) // => { Касса: Строка, Сумма: Число } | Неопределено
