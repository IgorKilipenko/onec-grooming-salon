...
Процедура ПриСозданииНаСервере(отказ, __)
    Если Параметры.Свойство("Основание")
        ...
        Если структураОплаты.ПризнакОплаты = Перечисления.ОплатаДокумента.ПолностьюОплачен Тогда
...
Функция получитьСкрываемыеПоляПриИзмененииВидаОперации()
    ...
    Если этоПрочееПоступление() Тогда
...
&НаКлиенте
Процедура заполнитьПоляФормыЗначениямиПоУмолчанию()
