...
Функция КонвертироватьТаблицуВМассив(Знач таблица) Экспорт
    колонкиТаблицы = Новый Массив;
    Для Каждого колонка Из таблица.Колонки Цикл
        колонкиТаблицы.Добавить(колонка.Имя);
    КонецЦикла;

    строкаМассиваИнициализатор = Новый ФиксированнаяСтруктура(СтрСоединить(колонкиТаблицы, ","));
    результат = Новый Массив(таблица.Количество());

    сч = 0;
    Для Каждого строкаТаблицы Из таблица Цикл
        строкаМассива = Новый Структура(строкаМассиваИнициализатор);
        ЗаполнитьЗначенияСвойств(строкаМассива, строкаТаблицы);
        результат.Установить(сч, строкаМассива);
        сч = сч + 1;
    КонецЦикла;
